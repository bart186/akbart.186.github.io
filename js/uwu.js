const s = (p) => {
  ...
  p.setup = () => {
      ...
      demo1Shader.setUniform('u_texture', mp4)
      demo1Shader.setUniform('u_tResolution', [mp4.width, mp4.height])
  }
