...
document.addEventListener("DOMContentLoaded", function () {
  const lyrics = [
    "INI AKU BUAT ",
    " HAL LUCU TERUS UNTUK PACARKU",
    " YANG PALING CANTIK SEABAD INII CANTIK SELALU",
    " AKU BUATIN KARENAA AKU GAMAU ANGGURIN POTO CANTIKKNY",
    " DAN DIA SELALU CANTIK DIMATAKUU",
